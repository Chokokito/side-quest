...
import { Building2, Rocket, ShieldCheck, Handshake, ArrowRight } from "lucide-react";
...
const benefits = [
  {
    ...
    description: "Chega de portfólios genéricos. Nossos designers já entregaram projetos visuais complexos e validados.",
    color: "from-blue-500 to-cyan-400",
  },
  {
    icon: Rocket,
    title: "Prontos para o Mercado",
    description: "Alunos da Zion treinados para lidar com briefings reais, prazos e ferramentas da indústria desde o dia 1.",
    color: "from-purple-500 to-pink-500",
  },
  {
    icon: Handshake,
    title: "Olhar Estratégico",
    description: "Formamos criativos que entendem de negócios, não apenas de ferramentas. Design que converte.",
        ...
        <div className="flex flex-col lg:flex-row items-center gap-16">
          ...
          <div className="flex-1 space-y-8 text-center lg:text-left items-center justify-center ">
            ...
            <h2 className="text-4xl md:text-5xl font-bold leading-tight">
              Sua próxima contratação de <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-400">elite</span> está aqui.
            </h2>

            <p className="text-lg text-gray-300 leading-relaxed max-w-xl mx-auto lg:mx-0">
              Não perca tempo filtrando centenas de currículos. A Side Quest conecta sua empresa diretamente aos talentos que já provaram seu valor na prática.
            </p>
          ...
          <div className="flex-1 grid gap-6">
            {benefits.map((item, index) => (
              ...
              >
                <div className={`p-3 rounded-xl bg-[#E5D0FF]/90 shadow-lg group-hover:scale-110 transition-transform duration-300`}>
